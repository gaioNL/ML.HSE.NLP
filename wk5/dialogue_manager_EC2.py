...
class ThreadRanker(object):
    ...
    def __load_embeddings_by_tag(self, tag_name):
        ...
        embeddings_path = os.path.join(self.thread_embeddings_folder, tag_name + "_" + str(1)+".pkl")
        thread_ids, thread_embeddings = unpickle_file_joblib(embeddings_path)

        #for i in range(1,4):
        #    embeddings_path = os.path.join(self.thread_embeddings_folder, tag_name + "_" + str(i)+".pkl")
        #    tmp_thread_ids, tmp_thread_embeddings = unpickle_file_joblib(embeddings_path)
        #    print(type(tmp_thread_embeddings))
        #    thread_ids.append(tmp_thread_ids)
        #    thread_embeddings.append(tmp_thread_embeddings)
